-- ===============================================
-- TRIGGER SIN FUNCIÓN (ALTERNATIVA)
-- ===============================================

CREATE OR ALTER TRIGGER tr_actualizar_precio_por_promocion
ON contratos_promociones
...
PRINT '✅ Trigger tr_actualizar_precio_por_promocion creado (sin función)';