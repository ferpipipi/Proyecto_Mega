...
public interface ISuscriptorService
{
  ...
  /// </summary>
  Task<EstadisticasSuscriptoresDto> ObtenerEstadisticasAsync();
  ...
  /// <summary>
  /// Busca un suscriptor por término de búsqueda
  /// </summary>
  Task<SuscriptorDto?> BuscarSuscriptorAsync(string termino);
